...
Triangle::Triangle(float ax, float ay, float az, float bx, float by, float bz, float cx, float cy, float cz){
    ...
    vertices[0] = ax;   vertices[1] = ay;   vertices[2] = az; //vertex 1
    vertices[3] = bx;   vertices[4] = by;   vertices[5] = bz; //vertex 2
    vertices[6] = cx;   vertices[7] = cy;   vertices[8] = cz; //vertex 3
    
    //colours
    colours[0] = ax;   colours[1] = ay;   colours[2] = az; //vertex 1, Red/Green/Blue
    colours[3] = bx;   colours[4] = by;   colours[5] = bz; //vertex 2, Red/Green/Blue
    colours[6] = cx;   colours[7] = cy;   colours[8] = cz; //vertex 3, Red/Green/Blue
...
void Triangle::getA(float* A){
    A[0] = vertices[0];
    A[1] = vertices[1];
    A[2] = vertices[2];
}

void Triangle::getB(float* B){
    B[0] = vertices[3];
    B[1] = vertices[4];
    B[2] = vertices[5];
}

void Triangle::getC(float* C){
    C[0] = vertices[6];
    C[1] = vertices[7];
    C[2] = vertices[8];
}